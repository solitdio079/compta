...
export default function Navbar() {
    ...
    return (
        <nav className="navbar rounded-box shadow-base-300/20 shadow-sm">
            <div className="w-full md:flex md:items-center md:gap-2 items-center">
                <div className="flex items-center justify-between">
                    <div className="navbar-start items-center justify-between max-md:w-full">
                        <a href="/" aria-label="Homepage Link" className="flex items-center gap-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path
                                ...
                                fill="currentColor"
                            /></svg>
                            <span className="text-xl font-bold">Compta</span>
                        </a>
                        <div className="md:hidden">
                            <div className="flex items-center gap-2">
                                ...
                                >
                                    <span className="icon-[tabler--language] size-4"></span>
                                    <span className="text-xs font-medium uppercase">{language}</span>
                                </button>
                                <button type="button" className="collapse-toggle btn btn-outline btn-secondary btn-sm btn-square" data-collapse="#main-navbar-collapse" aria-controls="main-navbar-collapse" aria-label="Toggle navigation" >
                ...
                <div id="main-navbar-collapse" className="md:navbar-end collapse hidden grow basis-full overflow-hidden transition-[height] duration-300 max-md:w-full" >
                    <ul className="menu md:menu-horizontal items-center gap-2 p-0 text-base max-md:mt-2">
