...
export function meta() {
  return [
    { title: "Accounting - Compta" },
    { name: "description", content: "Accounting services" },
  ];
}
        ...
        <div className="container mx-auto max-w-3xl">
          <div className="bg-base-100 rounded-lg shadow-base-300/20 shadow-sm">
            <div className="bg-base-300/10 rounded-t-lg p-4 flex items-center gap-3">
              <span className="icon-[tabler--calculator] size-6 text-primary"></span>
              <h1 className="text-xl font-bold">{t("accounting")}</h1>
            </div>
